...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Имя    = "УправлениеПарком";
	Описание.Версия = "1.0.1.12";
КонецПроцедуры
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик = Обработчики.Добавить();
  	...
  	Обработчик.Идентификатор	   = "15f83555-c8d9-4d3e-bd8e-e9e1cf8f152b";
  	Обработчик.Комментарий		   = НСтр("ru = 'Перенос файлов из хранилища значений в присоединенные файлы'");
  	  	
  	Обработчик = Обработчики.Добавить();
  	Обработчик.Версия              = "1.0.1.8";
  	Обработчик.Процедура           = "ОбновлениеИнформационнойБазыПАРеализация.АктуализироватьВидКонткатнойИнформации";
  	Обработчик.РежимВыполнения     = "Оперативно";
  	...
  	Обработчик.РежимВыполнения     = "Отложенно";
  	Обработчик.Идентификатор	   = "30686204-90a1-4c2c-b709-ce2f9a277cdf";
  	Обработчик.Комментарий		   = НСтр("ru = 'Перенос телефона в подистему Контактная информация'");	
КонецПроцедуры
